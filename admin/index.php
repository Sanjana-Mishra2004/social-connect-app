...
$totalGroups = totalChatGroupsCount();
...
<head>
  ...
  <title>MyCollegeConnect | Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="../assets/images/social-media.png" alt="AdminLoaderLogo" height="60" width="60">
    </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="../assets/images/myicon2.jpg" alt="AdminLogo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">MyCollegeConnect</span>
      </a>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labeledby="navbarDropdown">
                  <li><a class="dropdown-item text-dark" href="?user_report"><i class="nav-icon fas fa-file"></i>User wise Report</a></li>
                  <!-- <li><hr class="dropdown-divider text-dark"></li> -->
                  <li><a class="dropdown-item text-dark" href="?date_report"><i class="nav-icon fas fa-file"></i>Date wise Report</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          } elseif(isset($_GET['user_report'])){
          } elseif(isset($_GET['date_report'])){
          } else {
          ?>
            <div class="row">
          ...
          <div class="row">
            ...
            ?>
              <div class="card card-primary col-12">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <?= show_error('adminprofile') ?>
                <form method="post" action="php/admin_actions.php?updateprofile">
                  <input type="hidden" name="user_id" value="<?= $admin['admin_id'] ?>">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" name="name" value="<?= $admin['name'] ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name" required>
                    </div>
                    <div class="form-group">
            ...
            <?php
              ...
              include ('pages/user_report.php');
          
            }elseif(isset($_GET['date_report'])){
              include ('pages/date_report.php');
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2025 <a href="#" target="_blank">MyCollegeConnect.in</a></strong>
      All rights reserved.
